...
public class clsMenu {
	...
	/**
	 * Este metodo se encarga de solicitar al usuario alg�n dato del profesor cuyos datos queremos eliminar, de tal
...
/**
 * Este metodo se encarga de solicitar al usuario alg�n dato del profesor cuyos datos queremos modificar, de tal
 * forma que a trav�s de un metodo de la clase clsGestor se pueda acceder a los datos de dicho
